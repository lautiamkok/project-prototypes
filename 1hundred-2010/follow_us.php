...
<body>
	...
	<div id="container">
		...
		<div id="body" class="round-corner-10px">
			...
			<!--liquid template-->
			<div id="follow-us" class="right follow-us">
			
				<!--come-join-us-->
				<div id="come-join-us" class="left round-corner-3px ">
					
					<h3><a href="#"><span class="hide">Come join us in the Twitosphere</span></a></h3>
					<p>Be first to hear about our competitions,<br/> keep up-to-date with range development<br/> and most importantly, we can<br/> keep connected.</p>
					
				</div>
				<!--come-join-us-->
				
				<!--become-a-fan-->
				<div id="become-a-fan" class="right round-corner-3px ">
				
					<h3><a href="#"><span class="hide">Become a Fan on the Book of Faces</span></a></h3>
					<p>Post pictures of yourself in our tees,<br/> or your artwork hanging on the walls,<br/> connect with other fans, learn about<br/> new competitions.</p>
